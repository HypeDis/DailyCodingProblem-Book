...
"""
"""  
initialize board based on min xy and max xy coordinates of incoming data
generate new board that is 1 cell wider and taller than the previous board
re render next frame and cut the board down to size
"""